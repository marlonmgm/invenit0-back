...
module.exports.security = {
  ...
  ***************************************************************************/
  ...
  cors: {
    allRoutes: true,
    allowOrigins: '*',    
    //allowOrigins: ['http://localhost:4200','http://0.0.0.0:8080','http://localhost:1337',
      //              'http://0.0.0.0:1337','http://0.0.0.0:4200','https://0.0.0.0:4200'],
    allowCredentials: false,
    allowRequestHeaders: 'x-token, Content-Type, Authorization, Accept-Language'
  },
